...
coche=Coches("VM","Blanco","2020",220,180,4)
print(coche._color,coche.acelerar())

camion=Camiones("VM","Blanco a perlado","2020",220,180,4,2,2500)
print(camion._color,camion.acelerar())

camioneta=Camionetas("VM","Azul","2020",220,180,4,"delantera",True)
